...
async function initiateCollection({
  ...
  // {{CALLBACK_FUNCTION}} — substituted at clone time with the paired webhook function name
  const callback = `${Deno.env.get("SUPABASE_URL")}/functions/v1/{{CALLBACK_FUNCTION}}`;
